...
colnames(Corpus_frecu_mat_limpio_mat) <- unique_labels
...
win.graph()
comparison.cloud(Corpus_frecu_mat_limpio_mat, max.words=500, random.order=FALSE,c(4,0.4), title.size=1.4)
#dev.off()
